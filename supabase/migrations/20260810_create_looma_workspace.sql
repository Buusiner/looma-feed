-- Looma workspace schema: publications, opportunities, connections, proposals and settings.
-- Safe to apply to production: all objects are created only when absent.
